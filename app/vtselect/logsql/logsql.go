...
func ProcessFieldValuesRequest(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	startTime := time.Now()
	values, err := vtstorage.GetFieldValues(qctx, fieldName, filter, uint64(limit))
	if err != nil {
...
func ProcessStreamFieldNamesRequest(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	startTime := time.Now()
	names, err := vtstorage.GetStreamFieldNames(qctx, filter)
	if err != nil {
...
func ProcessStreamFieldValuesRequest(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	startTime := time.Now()
	values, err := vtstorage.GetStreamFieldValues(qctx, fieldName, filter, uint64(limit))
	if err != nil {
